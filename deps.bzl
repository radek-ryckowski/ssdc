...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_lotusdblabs_lotusdb_v2",
        importpath = "github.com/lotusdblabs/lotusdb/v2",
        sum = "h1:rCBrwED8Po12FzrxxX4zppxoHb2O+sCtddyW4kyDiCQ=",
        version = "v2.1.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_rosedblabs_diskhash",
        importpath = "github.com/rosedblabs/diskhash",
        sum = "h1:BNp46nsknQivr3Gxzc6ytzG7xtBscBnLYZIkr0UfCko=",
        version = "v0.0.0-20230910084041-289755737e2a",
    )
    go_repository(
        name = "com_github_rosedblabs_wal",
        importpath = "github.com/rosedblabs/wal",
        sum = "h1:oxZYTPX/u4JuGDW98wQ1YamWqerlrlSUFKhgP6Gd/Ao=",
        version = "v1.3.6",
    )
    go_repository(
